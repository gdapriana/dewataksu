...
import DestinationsTable from "@/app/(root)/admin/destinations/_components/items/table";
    ...
    <div className="mt-4 gap-8 w-full flex flex-col justify-start items-stretch">
      <div className="flex gap-4 justify-between items-center flex-wrap">
        <h3 className="font-bold text-lg">
          {pagination?.total} Total Destinations
        </h3>
      ...
      {pagination && pagination.total > limit && !loading && (
